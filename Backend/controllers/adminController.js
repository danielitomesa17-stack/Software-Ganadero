...
// 2. Obtener Usuarios (para la tabla de gestión)
...
// 3. Crear nueva Hacienda (con Transacción y Auditoría)
export const crearNuevaHacienda = async (req, res) => {
    ...
    try {
        ...
        const [hacienda] = await connection.query("INSERT INTO haciendas (nombre) VALUES (?)", [nombreHacienda]);
