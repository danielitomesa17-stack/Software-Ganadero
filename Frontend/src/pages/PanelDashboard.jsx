  ...
  <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
    ...
    <div>
      ...
      <div className="flex items-baseline gap-2">
        <span className="text-lg sm:text-2xl font-bold text-gray-800">{value}</span>
...
const Dashboard = () => {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-lg sm:text-2xl font-bold text-gray-800">Resumen del Hato</h1>
      ...
      <div className="bg-white p-4 sm:p-8 rounded-2xl border border-gray-100 shadow-sm h-64 flex items-center justify-center text-gray-400 border-dashed border-2">
